const smoke = document.querySelector('.home__smoke')
class Fog {
		...
		switch (this.direction) {
			case 0:
				...
				if (this.x + this.width < 0) {
					this.x = smoke.clientWidth + this.width
				}
				break
			case 1:
				this.x += this.velocity
				if (this.x + this.width > smoke.width) {
